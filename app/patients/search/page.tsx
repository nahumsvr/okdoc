...
import {
  PatientResultCard,
  PatientResultProps,
} from "../../components/search/PatientResultCard";
    ...
    const fetchPatients = async () => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (json && json.data) {
            const fetchedPatients: PatientResultProps[] = json.data.map(
              (p: any) => ({
                id: p._id,
          ...
          <div className="max-w-5xl mx-auto space-y-12">
            ...
            <section>
              ...
              <p className="text-on-surface-variant font-body mb-8 max-w-2xl">
                Ingrese los criterios de búsqueda para localizar un registro
                clínico en el sistema Moscati Clinical Precision.
              </p>
              ...
              <div className="grid grid-cols-1 gap-4">
                {patients.length > 0 ? (
                  ...
                  <p className="text-on-surface-variant">
                    Cargando pacientes o sin resultados...
                  </p>
                )}
              </div>
            </section>
