...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    // TODO: conectar con tu endpoint de autenticación
    setTimeout(() => {
      setLoading(false)
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border border-[#E0E0E0] overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="px-8 py-7 flex flex-col gap-5">
            ...
            {/* Error */}
            {error && (
              <div className="flex items-center gap-2 rounded-lg px-4 py-3" style={{ background: "rgba(0,45,88,0.06)", border: "1px solid #002D58" }}>
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <span className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none">
                  <svg className="w-4 h-4 text-[#888888]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="px-8 pb-6 flex flex-col gap-3">
            <p className="text-center text-[12px] text-[#888888]" style={{ fontFamily: "Manrope, sans-serif" }}>
              ¿No tienes cuenta?{" "}
              <a href="/register" className="font-bold text-[#C6A152] hover:text-[#002D58] transition-colors">
                Registrarse
              </a>
            </p>
            <p className="text-center text-[11px] text-[#BBBBBB]" style={{ fontFamily: "Manrope, sans-serif" }}>
        ...
        {/* Badge inferior */}
        <p className="text-center text-[11px] text-[#BBBBBB] mt-4" style={{ fontFamily: "Manrope, sans-serif" }}>
